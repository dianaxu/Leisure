...
//            sendDownloadReceiver(Constant.DownloadReceiverState.PROMPT_START, null, chapterId, "开始下载", true);
//        }
//
//        @Override
...
//
//        @Override
//        public void onFail(ComicChapterBean chapter, boolean isConnWifi) {
//            String msg = "下载失败";
//            if (!isConnWifi) {
//                cancelTask();
//                msg = (String) getResources().getText(R.string.net_not_connected_wifi);
//                updateChaptersStateToCancel();
//                updateBooksStateToCancel();
//            } else {
//                //更新
//                chapter.setCacheState(Constant.DownloadState.DOWNLOAD_CANCEL);
//                mDaoSession.update(chapter);
//                updateBookStateToCancel();
//            }
//            sendDownloadReceiver(Constant.DownloadReceiverState.PROMPT_FAIL, chapter.getBookId(),
//                    chapter.get_id(), msg, isConnWifi);
//        }
//    };
//
//
...
//    }
//
//    private void sendDownloadReceiver(int prompt, Long bookId, Long chapterId, String message, boolean hasWifi) {
//        DownloadReceiver.ReceiverPromptBean receiverBean = new DownloadReceiver.ReceiverPromptBean();
//        receiverBean.chapterId = chapterId;
//        receiverBean.bookId = bookId;
//        receiverBean.message = message;
//        receiverBean.isConnWifi = hasWifi;
...
//    }
//
//    private void updateBookStateToCancel() {
...
//
//
//    private void updateBooksStateToCancel() {
//        String sqlStr = "update comic_book_bean set cache_state = " + Constant.DownloadState.DOWNLOAD_CANCEL
//                + " where cache_state = " + Constant.DownloadState.DOWNLOADING;
//        mDaoSession.getDatabase().execSQL(sqlStr);
//    }
//
//    private void updateChaptersStateToCancel() {
//        String sqlStr = "update comic_chapter_bean set cache_state = " + Constant.DownloadState.DOWNLOAD_CANCEL
//                + " where cache_state = " + Constant.DownloadState.DOWNLOADING;
//        mDaoSession.getDatabase().execSQL(sqlStr);
//    }
//
