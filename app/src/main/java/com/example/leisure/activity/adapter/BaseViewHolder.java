...
public class BaseViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public static BaseViewHolder getInstance(Context mContext, int resourseId, ViewGroup parent) {
        View view = LayoutInflater.from(mContext).inflate(resourseId, parent, false);
    ...
    public void setItemListener(int position, onItemClickListener listener) {
