...
public class DownloadComicAdapter extends BaseRecyclerViewAdapter<BookShelf> implements View.OnClickListener {
    ...
    public DownloadComicAdapter(@NonNull Context context, List<BookShelf> data) {
        super(context, data);
    }
    ...
    public void onBindView(BaseViewHolder holder, int position) {
        ...
        holder.setTextOfTextView(R.id.tv_name, bean.getName()); //书名
    ...
    public interface onTaskListener {
        //开始这本书的缓存任务
        void startTask(BookShelf bean);

        //取消这本书的缓存任务
        void stopTask(BookShelf bean);
    }
}
