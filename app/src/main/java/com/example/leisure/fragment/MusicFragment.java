 ...
 */
public class MusicFragment extends Fragment implements BaseRecyclerViewAdapter.OnRecyclerViewItemClickListener<ChannellistBean> {
...
//        mRvView.addItemDecoration(new SpacesItemDecoration(spacing));
        ...
        mAdapter = new BaseRecyclerViewAdapter<ChannellistBean>(getContext(), mLsData) {
            ...
            public void onBindView(BaseViewHolder holder, int position) {
                ...
                holder.setTextOfTextView(R.id.tv_text, bean.name);
