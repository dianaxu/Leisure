...
import com.example.leisure.adapter.WYNewsAdapter;
 ...
 * 问题7：加载更多需要再看下
 */
public class WYNewsFragment extends Fragment implements BaseRecyclerViewAdapter.OnRecyclerViewItemClickListener<WangYiNewsBean> {
